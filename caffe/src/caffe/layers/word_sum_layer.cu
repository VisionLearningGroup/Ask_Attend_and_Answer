...
//    caffe_gpu_gemm<Dtype>(CblasNoTrans, CblasNoTrans, 1, K_*N_, B_, (Dtype)1.,
//        bias_multiplier_.gpu_data(), top_diff, (Dtype)1.,
//        this->blobs_[1]->mutable_gpu_diff());
//    for (int j=0; j<bottom[0]->shape(0); ++j){
//      caffe_gpu_gemv<Dtype>(CblasTrans, K_, N_, (Dtype)1., top_diff + j*K_*N_,
//          bias_multiplier_.gpu_data(), (Dtype)1.,
//          this->blobs_[1]->mutable_gpu_diff());
//    }
  }
